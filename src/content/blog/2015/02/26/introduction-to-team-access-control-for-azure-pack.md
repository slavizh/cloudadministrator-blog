...
heroImage: "/media/wordpress/2015/02/image9.png"
...
[![image](/media/wordpress/2015/02/image9.png "image")](/media/wordpress/2015/02/image9.png)
...
[![image](/media/wordpress/2015/02/image10.png "image")](/media/wordpress/2015/02/image10.png)

When the command finishes we have the setup itself:

[![image](/media/wordpress/2015/02/image11.png "image")](/media/wordpress/2015/02/image11.png)
...
[![image](/media/wordpress/2015/02/image12.png "image")](/media/wordpress/2015/02/image12.png)

[![image](/media/wordpress/2015/02/image13.png "image")](/media/wordpress/2015/02/image13.png)

I select all roles for install:

[![image](/media/wordpress/2015/02/image14.png "image")](/media/wordpress/2015/02/image14.png)

[![image](/media/wordpress/2015/02/image15.png "image")](/media/wordpress/2015/02/image15.png)

[![image](/media/wordpress/2015/02/image16.png "image")](/media/wordpress/2015/02/image16.png)

[![image](/media/wordpress/2015/02/image17.png "image")](/media/wordpress/2015/02/image17.png)

[![image](/media/wordpress/2015/02/image18.png "image")](/media/wordpress/2015/02/image18.png)

When the installation finishes we can logon to the Azure Pack Admin Portal and check the RP:

[![image](/media/wordpress/2015/02/image19.png "image")](/media/wordpress/2015/02/image19.png)
...
[![image](/media/wordpress/2015/02/image20.png "image")](/media/wordpress/2015/02/image20.png)
...
[![image](/media/wordpress/2015/02/image21.png "image")](/media/wordpress/2015/02/image21.png)
...
[![image](/media/wordpress/2015/02/image22.png "image")](/media/wordpress/2015/02/image22.png)
...
[![image](/media/wordpress/2015/02/image23.png "image")](/media/wordpress/2015/02/image23.png)
...
[![image](/media/wordpress/2015/02/image24.png "image")](/media/wordpress/2015/02/image24.png)

This hosting plan needs to have resources from VM Clouds and Team Manager.

[![image](/media/wordpress/2015/02/image25.png "image")](/media/wordpress/2015/02/image25.png)

[![image](/media/wordpress/2015/02/image26.png "image")](/media/wordpress/2015/02/image26.png)
...
[![image](/media/wordpress/2015/02/image27.png "image")](/media/wordpress/2015/02/image27.png)

Next you need to configure Team Manager for that plan. Let’s say we will have maximum 10 teams for this plan and save it:

[![image](/media/wordpress/2015/02/image28.png "image")](/media/wordpress/2015/02/image28.png)

Now let’s create another plan for Members:

[![image](/media/wordpress/2015/02/image29.png "image")](/media/wordpress/2015/02/image29.png)

This hosting plan will be attached only to Team Member service:

[![image](/media/wordpress/2015/02/image30.png "image")](/media/wordpress/2015/02/image30.png)

[![image](/media/wordpress/2015/02/image31.png "image")](/media/wordpress/2015/02/image31.png)

This plan does not need any configuration.

Next we can make both plans public:

[![image](/media/wordpress/2015/02/image32.png "image")](/media/wordpress/2015/02/image32.png)

Now we need to create a user and subscription and assign it to the Managers plan:

[![image](/media/wordpress/2015/02/image33.png "image")](/media/wordpress/2015/02/image33.png)

Let’s also create user and subscription and assign it to Members plan:

[![image](/media/wordpress/2015/02/image34.png "image")](/media/wordpress/2015/02/image34.png)
...
[![image](/media/wordpress/2015/02/image35.png "image")](/media/wordpress/2015/02/image35.png)

Now let’s login to Azure Pack Tenant portal with manager user:

[![image](/media/wordpress/2015/02/image36.png "image")](/media/wordpress/2015/02/image36.png)
...
[![image](/media/wordpress/2015/02/image37.png "image")](/media/wordpress/2015/02/image37.png)

When you download that file you go again to Tenant portal –> Team Manager –> Management Certificates –> Upload

[![image](/media/wordpress/2015/02/image38.png "image")](/media/wordpress/2015/02/image38.png)
...
[![image](/media/wordpress/2015/02/image39.png "image")](/media/wordpress/2015/02/image39.png)

[![image](/media/wordpress/2015/02/image40.png "image")](/media/wordpress/2015/02/image40.png)

Once we have team we can assign quota to that team in  the form of cores and memory:

[![image](/media/wordpress/2015/02/image41.png "image")](/media/wordpress/2015/02/image41.png)
...
[![image](/media/wordpress/2015/02/image42.png "image")](/media/wordpress/2015/02/image42.png)

Once we add that member to that team we can also specify quota for that specific member:

[![image](/media/wordpress/2015/02/image43.png "image")](/media/wordpress/2015/02/image43.png)

[![image](/media/wordpress/2015/02/image44.png "image")](/media/wordpress/2015/02/image44.png)

The cool part is that on the Subscription of the Manager you can see how many members and teams you have:

[![image](/media/wordpress/2015/02/image45.png "image")](/media/wordpress/2015/02/image45.png)

Now let’s login as member and see what we have available:

[![image](/media/wordpress/2015/02/image46.png "image")](/media/wordpress/2015/02/image46.png)

As you can see we have only one Resource provider and that is Team Member:

[![image](/media/wordpress/2015/02/image47.png "image")](/media/wordpress/2015/02/image47.png)

Under there we can see our assigned quota:

[![image](/media/wordpress/2015/02/image48.png "image")](/media/wordpress/2015/02/image48.png)

On Virtual Machines you will see the virtual machines you have access to.

[![image](/media/wordpress/2015/02/image49.png "image")](/media/wordpress/2015/02/image49.png)

Of course to have that you will need to create VMs:

[![image](/media/wordpress/2015/02/image50.png "image")](/media/wordpress/2015/02/image50.png)

[![image](/media/wordpress/2015/02/image51.png "image")](/media/wordpress/2015/02/image51.png)

In VMM the VM is created on behalf of the Manager subscription:

[![image](/media/wordpress/2015/02/image52.png "image")](/media/wordpress/2015/02/image52.png)

Team Managers can also see it:

[![image](/media/wordpress/2015/02/image53.png "image")](/media/wordpress/2015/02/image53.png)

You can be more granular on permissions for VMs by creating a role:

[![image](/media/wordpress/2015/02/image54.png "image")](/media/wordpress/2015/02/image54.png)

Than you can add members to that role:

[![image](/media/wordpress/2015/02/image55.png "image")](/media/wordpress/2015/02/image55.png)

And assign permissions to that role for a VM:

[![image](/media/wordpress/2015/02/image56.png "image")](/media/wordpress/2015/02/image56.png)

So you can have only certain set of VM permissions for those members:

[![image](/media/wordpress/2015/02/image57.png "image")](/media/wordpress/2015/02/image57.png)
