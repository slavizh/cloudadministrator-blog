...
heroImage: "/media/wordpress/2016/06/image.png"
...
[![image](/media/wordpress/2016/06/image.png "image")](/media/wordpress/2016/06/image.png)
...
[![image](/media/wordpress/2016/06/image1.png "image")](/media/wordpress/2016/06/image1.png)

Besides some standard fields and Solution field the type has some others like:

**Detail** – Description of what has been run

[![image](/media/wordpress/2016/06/image2.png "image")](/media/wordpress/2016/06/image2.png)

**Operation Category** – Some categorization for the different operations that are being executed

[![image](/media/wordpress/2016/06/image3.png "image")](/media/wordpress/2016/06/image3.png)

**HelpLink** – Link to OMS Log Analytics documentation for that specific solution

[![image](/media/wordpress/2016/06/image4.png "image")](/media/wordpress/2016/06/image4.png)

**OperationStatus** – Status of the operation that has been executed on specific server

[![image](/media/wordpress/2016/06/image5.png "image")](/media/wordpress/2016/06/image5.png)
